"""
Django settings for testqauser_1 project.
...
ROOT_URLCONF = 'testqauser_1.urls'
...
WSGI_APPLICATION = 'testqauser_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testqauser_1 API",
    "DESCRIPTION": "API documentation for testqauser_1 App",
    "VERSION": "v1",
}
